...
public class lab3 extends JFrame {
    ...
    public lab3() {
        ...
        tableSelector.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                switchTable();
                JOptionPane.showMessageDialog(lab3.this, "Вы выбрали таблицу: " + tableSelector.getSelectedItem(), "Информация", JOptionPane.INFORMATION_MESSAGE);
            }
        });
        ...
        searchButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(lab3.this, "Результаты поиска по запросу: " + searchText, "Информация", JOptionPane.INFORMATION_MESSAGE);
            }
        });
